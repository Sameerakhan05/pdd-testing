...
- **Build Number**: #1
- **Execution Date**: Wed, 24 Jun 2026 07:45:40 GMT
- **Git Commit**: `N/A`
- **Branch**: `main`
...
* ✗ **TC_NAV_005** - Navigation Verification - Case 5
  - *Reason*: AssertionError: State mismatch on scenario index 114
* ✗ **TC_DASH_010** - Dashboard Verification - Case 10
  - *Reason*: AssertionError: State mismatch on scenario index 149
* ✗ **TC_FORM_008** - Forms Verification - Case 8
  - *Reason*: AssertionError: State mismatch on scenario index 167
