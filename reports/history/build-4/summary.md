...
- **Build Number**: #4
- **Execution Date**: Wed, 24 Jun 2026 07:14:28 GMT
- **Git Commit**: `60cbe70e81282f2b04555d24d9c2dfd32f22cc47`
- **Branch**: `main`
...
### FAILED TESTS
* ✗ **TC_AUTH_027** - Authentication Verification - Case 27
  - *Reason*: AssertionError: State mismatch on scenario index 26
* ✗ **TC_AZ_014** - Authorization Verification - Case 14
  - *Reason*: AssertionError: State mismatch on scenario index 53
* ✗ **TC_DASH_006** - Dashboard Verification - Case 6
  - *Reason*: AssertionError: State mismatch on scenario index 145
* ✗ **TC_CRUD_015** - CRUD Operations Verification - Case 15
  - *Reason*: AssertionError: State mismatch on scenario index 214
* ✗ **TC_CRUD_023** - CRUD Operations Verification - Case 23
  - *Reason*: AssertionError: State mismatch on scenario index 222
*... and 1 more.*
