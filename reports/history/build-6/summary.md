...
- **Build Number**: #6
- **Execution Date**: Wed, 24 Jun 2026 08:00:44 GMT
- **Git Commit**: `2c31f0a34d65eeb58994408d2ea441ad74a9ea59`
- **Branch**: `main`
...
### FAILED TESTS
* ✗ **TC_AZ_020** - Authorization Verification - Case 20
  - *Reason*: AssertionError: State mismatch on scenario index 59
* ✗ **TC_REG_005** - Registration Verification - Case 5
  - *Reason*: AssertionError: State mismatch on scenario index 74
* ✗ **TC_DASH_013** - Dashboard Verification - Case 13
  - *Reason*: AssertionError: State mismatch on scenario index 152
* ✗ **TC_FORM_027** - Forms Verification - Case 27
  - *Reason*: AssertionError: State mismatch on scenario index 186
* ✗ **TC_FORM_036** - Forms Verification - Case 36
  - *Reason*: AssertionError: State mismatch on scenario index 195
*... and 3 more.*
